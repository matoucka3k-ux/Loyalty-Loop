    ...
    <div style={{minHeight:'100vh',background:'#f8faff',display:'flex',alignItems:'center',justifyContent:'center',padding:24}}>
      <div style={{width:'100%',maxWidth:420}}>
        <div style={{textAlign:'center',marginBottom:32}}>
          ...
          <p style={{color:'#78716c',fontSize:14}}>Accédez à votre espace FideliPain</p>
        </div>
        ...
        <div style={{background:'white',borderRadius:20,padding:32,border:'1px solid #dbeafe',boxShadow:'0 4px 24px -8px rgba(30,64,175,0.08)'}}>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:16}}>
            <div>
              ...
              <div style={{position:'relative'}}>
                ...
                <input name="email" type="email" value={form.email} onChange={handle}
                  placeholder="jean@boulangerie.fr" className="input-base" style={{paddingLeft:40}} />
              </div>
            </div>
            <div>
              ...
              <div style={{position:'relative'}}>
                ...
                <input name="password" type="password" value={form.password} onChange={handle}
                  placeholder="••••••••" className="input-base" style={{paddingLeft:40}} />
              </div>
            </div>
            <button onClick={submit} disabled={loading}
              ...
              {loading ? <Loader2 style={{width:18,height:18,animation:'spin 1s linear infinite'}} /> : <><ArrowRight style={{width:16,height:16}} /> Se connecter</>}
            </button>
          </div>
