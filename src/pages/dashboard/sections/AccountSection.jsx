...
import { Building2, Mail, MapPin, Phone, Save, Loader2, Shield, FileText, Info, Users } from 'lucide-react'
      ...
      {tab === 'infos' && (
        <div style={{display:'flex',flexDirection:'column',gap:16}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:14}}>
              <div>
                ...
                <div style={{position:'relative'}}>
                  ...
                  <input
                    name="business_name" value={form.business_name} onChange={handle}
                    placeholder="Ma Boulangerie" className="input-base" style={{paddingLeft:40}}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{position:'relative'}}>
                  ...
                  <input
                    ...
                    placeholder="12 rue de la Paix, 75001 Paris" className="input-base" style={{paddingLeft:40}}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{position:'relative'}}>
                  ...
                  <input
                    ...
                    placeholder="06 12 34 56 78" className="input-base" style={{paddingLeft:40}}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{position:'relative'}}>
                  ...
                  <input
                    ...
                    className="input-base" style={{paddingLeft:40,opacity:0.6,cursor:'not-allowed'}}
                  />
                </div>
          ...
          <div style={{background:'#eff6ff',borderRadius:16,padding:20,border:'1px solid #bfdbfe'}}>
            <p style={{fontSize:13,fontWeight:600,color:'#1e3a5f',marginBottom:4}}>Votre lien de fidelite</p>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:16}}>
          <div style={{background:'white',borderRadius:16,padding:24,border:'1px solid #dbeafe'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:12}}>
              <p style={{fontSize:14,color:'#44403c',lineHeight:1.7}}>
                FideliPain collecte uniquement les donnees necessaires au fonctionnement du service : nom du commerce, email du gerant, et donnees clients (nom, email, points).
              </p>
              <p style={{fontSize:14,color:'#44403c',lineHeight:1.7}}>
                En tant que commercant, vous etes responsable des donnees de vos clients conformement au RGPD. Vos clients ont un droit d'acces, de rectification et de suppression de leurs donnees.
              </p>
              <p style={{fontSize:14,color:'#44403c',lineHeight:1.7}}>
                Les donnees ne sont jamais vendues ni partagees avec des tiers. Pour toute demande : <strong style={{color:'#1e40af'}}>contact@fidelipain.fr</strong>
              </p>
            </div>
          </div>
          ...
          <div style={{background:'white',borderRadius:16,padding:24,border:'1px solid #dbeafe'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:10}}>
              {[
                "L'abonnement FideliPain est mensuel ou annuel et renouvelable automatiquement.",
                "Vous pouvez annuler votre abonnement a tout moment depuis votre espace compte.",
                "Les donnees de vos clients restent votre propriete et vous sont restituees sur demande.",
                "FideliPain ne peut etre tenu responsable d'une mauvaise utilisation du service.",
                "Tout abus ou utilisation frauduleuse entraine la suspension immediate du compte.",
              ].map((item, i) => (
                <div key={i} style={{display:'flex',alignItems:'flex-start',gap:10,padding:'10px 14px',background:'#f8faff',borderRadius:10}}>
      ...
      {tab === 'about' && (
        <div style={{display:'flex',flexDirection:'column',gap:16}}>
          ...
          <div style={{background:'white',borderRadius:16,padding:24,border:'1px solid #dbeafe'}}>
            ...
            <p style={{fontSize:14,color:'#44403c',lineHeight:1.7}}>
              FideliPain aide les boulangers independants a fideliser leur clientele grace a un systeme de points simple et moderne. Nous remplacons les cartes tampons perdues par une solution digitale efficace.
            </p>
          </div>
          ...
          <div style={{background:'white',borderRadius:16,padding:24,border:'1px solid #dbeafe'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:12}}>
              {[
                ...
                <div key={i} style={{display:'flex',alignItems:'center',gap:12,padding:'14px 16px',background:'#f8faff',borderRadius:12}}>
          ...
          <div style={{background:'white',borderRadius:16,padding:24,border:'1px solid #dbeafe'}}>
            ...
            <a href="mailto:contact@fidelipain.fr"
              style={{display:'flex',alignItems:'center',gap:12,padding:'14px 16px',background:'#eff6ff',borderRadius:12,textDecoration:'none',border:'1px solid #bfdbfe'}}>
              <Mail style={{width:18,height:18,color:'#3b82f6',flexShrink:0}} />
              <div>
                <p style={{fontSize:13,color:'#a8a29e',marginBottom:2}}>Email</p>
          ...
          <div style={{background:'white',borderRadius:16,padding:24,border:'1px solid #dbeafe'}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12}}>
              {[
                ...
                <div key={i} style={{padding:'16px',background:'#f8faff',borderRadius:12,textAlign:'center'}}>
