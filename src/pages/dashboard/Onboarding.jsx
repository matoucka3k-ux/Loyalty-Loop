    ...
    <div style={{minHeight:'100vh',background:'linear-gradient(135deg,#eff6ff,#f8faff)',display:'flex',alignItems:'center',justifyContent:'center',padding:24}}>
      <div style={{maxWidth:560,width:'100%'}}>
        ...
        {step === 1 && (
          <div style={{background:'white',borderRadius:24,padding:40,border:'1px solid #dbeafe',boxShadow:'0 20px 60px -20px rgba(30,64,175,0.15)',textAlign:'center'}}>
            ...
            <p style={{color:'#78716c',fontSize:16,marginBottom:8}}>
              <strong style={{color:'#1e40af'}}>{merchant?.business_name}</strong> est maintenant sur FideliPain.
            </p>
            <p style={{color:'#a8a29e',fontSize:14,marginBottom:32}}>
              Configurons votre programme de fidelite en 2 minutes.
            </p>
          ...
          <div style={{background:'white',borderRadius:24,padding:40,border:'1px solid #dbeafe',boxShadow:'0 20px 60px -20px rgba(30,64,175,0.15)'}}>
            ...
            {loyaltyMode === 'products' && (
              <div>
                ...
                <p style={{fontSize:12,color:'#a8a29e'}}>Vous pourrez ajouter des produits depuis le dashboard.</p>
              </div>
            )}
        ...
        {step === 3 && (
          <div style={{background:'white',borderRadius:24,padding:40,border:'1px solid #dbeafe',boxShadow:'0 20px 60px -20px rgba(30,64,175,0.15)',textAlign:'center'}}>
            <div style={{fontSize:64,marginBottom:16}}>📲</div>
            <h2 style={{fontSize:22,fontWeight:800,color:'#1e3a5f',marginBottom:8}}>Votre QR code est pret !</h2>
