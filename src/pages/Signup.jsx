...
export default function Signup() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      if (profileError) {
        setError('Erreur creation profil : ' + profileError.message)
        setLoading(false)
        return
      }
      ...
      if (merchantError) {
        setError('Erreur creation commerce : ' + merchantError.message)
        setLoading(false)
        return
      }
      ...
      if (signInError) {
        setError('Compte cree ! Connectez-vous maintenant.')
        navigate('/login')
        return
      }
          ...
          <div style={{display:'flex',flexDirection:'column',gap:16}}>
            ...
            <div>
              ...
              <div style={{position:'relative'}}>
                ...
                <input
                  name="businessName" value={form.businessName} onChange={handle}
                  placeholder="Boulangerie Martin" className="input-base"
                  style={{paddingLeft:40}}
                  onKeyDown={e => e.key === 'Enter' && submit()}
                />
              </div>
            ...
            <div>
              ...
              <div style={{position:'relative'}}>
                ...
                <input
                  ...
                  placeholder="6 caracteres minimum" className="input-base"
